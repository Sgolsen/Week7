 ...
 */
public class ColumnsFragmentOne extends BaseFragment {

    private static final String TAG = ColumnsFragmentOne.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        layout = inflater.inflate(R.layout.fragment_columns_one,container,false);
        initView();
        setupView();
        return layout;
    }
    ...
    private void initView() {
        mImgOne = ((ImageView) layout.findViewById(R.id.columns_one_img_one));
        mImgTwo = ((ImageView) layout.findViewById(R.id.columns_one_img_two));
        mImgThree = ((ImageView) layout.findViewById(R.id.columns_one_img_three));
        mImgFour = ((ImageView) layout.findViewById(R.id.columns_one_img_four));

        mTxtOne = ((TextView) layout.findViewById(R.id.columns_one_text_one));
        mTxtTwo = ((TextView) layout.findViewById(R.id.columns_one_text_two));
        mTxtThree = ((TextView) layout.findViewById(R.id.columns_one_text_three));
        mTxtFour = ((TextView) layout.findViewById(R.id.columns_one_text_four));
    }
}
