 ...
 */
public class ImageFragmentSeven extends BaseFragment{
    private ImageView mImg;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        layout = inflater.inflate(R.layout.fragment_img_seven,container,false);
        initView();
        setupView();
        return layout;
    }
    ...
    private void initView() {
        mImg = ((ImageView) layout.findViewById(R.id.fragment_image_img_seven));
    }
}
